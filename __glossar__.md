...
> 3. Speicherort: thematisch passender Unterordner (z.B. `cannabis/`, `theorie/`, `algorithmen/`)
> 4. Dateistruktur:
>    - `# Titel — Untertitel`
...
> 6. Begriff aus Codeblock in Glossar-Block 1 übertragen (damit er ins Glossar kommt)
...
→ [[__sandbox__]] | [[energievampir_detektor]]
