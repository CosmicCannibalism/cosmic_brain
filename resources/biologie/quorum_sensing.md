...
```mermaid
graph LR
    A[Einzelzelle produziert Autoinduktor]
    B[Konzentration steigt mit Zelldichte]
    C{Schwellenwert erreicht?}
    D[Nein: keine Reaktion]
    E[Ja: kollektive Genaktivierung]
    A --> B --> C
    C -->|Nein| D
    C -->|Ja| E
    style E fill:#1a3a1a,stroke:#4a8
```
