...
graph LR
    ...
    L[Niedrige Granularität\n'schlecht' / 'gut']
    H[Hohe Granularität\n'enttäuscht' / 'erschöpft' / 'beschämt']
    R1[Undifferenzierte Reaktion]
    R2[Gezielte, adaptierte Reaktion]
    E --> L --> R1
    E --> H --> R2
    style L fill:#3a1a1a,stroke:#a44
    style H fill:#1a3a1a,stroke:#4a8
```
