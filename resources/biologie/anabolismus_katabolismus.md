...
```mermaid
graph TD
    M[Metabolismus — Stoffwechsel]
    M --> A[Anabolismus]
    M --> K[Katabolismus]
    A -->|Energie verbrauchen| B[Komplexe Strukturen\nProteine · DNA · Knochen]
    K -->|Energie freisetzen| C[Einfache Bausteine\nAminosäuren · ATP · CO₂]
    B -->|Katabolismus| C
    C -->|Anabolismus| B
    K --> AU[Autophagie — intern\nZellreparatur · Recycling]
    style M fill:#2a2a2a,stroke:#888
    style A fill:#1a3a1a,stroke:#4a8
    style K fill:#3a1a1a,stroke:#a44
    style AU fill:#1a1a3a,stroke:#44f
```
